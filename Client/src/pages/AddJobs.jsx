...
const AddJobs = () => {
    ...
    const onSubmitHandler = async (e)=>{
        ...
        try {
            ...
            const {data} = await axios.post(backendUrl+'/api/company/postJobs', {jobTitle, description, location, level, category, salary}, {headers:{ Authorization: `Bearer ${companyToken}`}})
